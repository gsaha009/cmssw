...
dqmInfoTkPhase2 = DQMEDAnalyzer('DQMEventInfo',
    subSystemFolder = cms.untracked.string('TrackerPhase2Digi')
)

TrackerPhase2DigimonDQMSource = cms.Sequence(pixDigiMon * otDigiMon)
'''
